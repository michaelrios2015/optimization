...
var pizzaElementGenerator = function(i) {
    ...
    pizzaImage.src = "images/pizza-min.png"; //minimized image
...
var resizePizzas = function(size) {
    ...
    function determineDx(elem, size) {
        ...
        var windowWidth = document.getElementById("randomPizzas").offsetWidth; //faster API
...
var pizzasDiv = document.getElementById("randomPizzas"); //bad in for loop
...
function updatePositions() {
    ...
    var scrollFactor = document.body.scrollTop / 1250 // not needed in for loop
    var items = document.querySelectorAll('.mover');
    var length = items.length; //makes for loop faster
    for (var i = 0; i < length; i++) {
        var phase = Math.sin(scrollFactor + (i % 5));
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    //an attempt at calculating the number of moving pizzas not quite working yet
    //var height = window.screen.height;
    //console.log(window.screen.height / 8);
    //var pizzas = height/((height/8) * 2);
    //console.log(pizzas);
    
    for (var i = 0; i < 24; i++) { // the most pizzas we will need
